    ...
    return (
        <div className="modern-dashboard">
            ...
            <div className="main-column">
                ...
                {/* 2. My Upload Statistics */}
                <div className="stats-panel">
                    <h3>My Upload Statistics</h3>
                    <div className="stats-grid">
                        ...
                        <div className="stat-card">
                            ...
                            <span className="stat-value pending">8</span>
                        </div>
                        <div className="stat-card">
                            <h4>Resolved</h4>
                            <span className="stat-value success">29</span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <React.Fragment key={c.id}>
                                        ...
                                        {expandedRowId === c.id && (
                                            <tr className="expanded-note-row">
                                                <td colSpan="3" style={{ padding: '1rem', backgroundColor: '#f8f9fa', borderLeft: '4px solid #4da8da' }}>
